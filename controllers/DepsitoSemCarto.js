...
var DepsitoSemCarto = require('../service/DepsitoSemCartoService');
...
module.exports.consultaContaPOST = function consultaContaPOST (req, res, next) {
  ...
  DepsitoSemCarto.consultaContaPOST(authenticationType,clientId,token,body)
...
module.exports.depositoConfPOST = function depositoConfPOST (req, res, next) {
  ...
  var token = req.swagger.params['token'].value;
  var body = req.swagger.params['body'].value;
  DepsitoSemCarto.depositoConfPOST(authenticationType,clientId,token,body)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
...
module.exports.depositoPOST = function depositoPOST (req, res, next) {
  ...
  var token = req.swagger.params['token'].value;
  var body = req.swagger.params['body'].value;
  DepsitoSemCarto.depositoPOST(authenticationType,clientId,token,body)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
