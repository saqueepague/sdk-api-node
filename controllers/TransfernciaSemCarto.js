...
var TransfernciaSemCarto = require('../service/TransfernciaSemCartoService');
...
module.exports.consultaContaPOST = function consultaContaPOST (req, res, next) {
  ...
  TransfernciaSemCarto.consultaContaPOST(authenticationType,clientId,token,body)
...
module.exports.transferenciaConfPOST = function transferenciaConfPOST (req, res, next) {
  ...
  var token = req.swagger.params['token'].value;
  var body = req.swagger.params['body'].value;
  TransfernciaSemCarto.transferenciaConfPOST(authenticationType,clientId,token,body)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
...
module.exports.transferenciaPOST = function transferenciaPOST (req, res, next) {
  ...
  var token = req.swagger.params['token'].value;
  var body = req.swagger.params['body'].value;
  TransfernciaSemCarto.transferenciaPOST(authenticationType,clientId,token,body)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
