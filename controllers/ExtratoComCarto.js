...
var ExtratoComCarto = require('../service/ExtratoComCartoService');
...
module.exports.extratoConfPOST = function extratoConfPOST (req, res, next) {
  ...
  ExtratoComCarto.extratoConfPOST(authenticationType,clientId,token,body)
...
module.exports.extratoPOST = function extratoPOST (req, res, next) {
  ...
  var token = req.swagger.params['token'].value;
  var body = req.swagger.params['body'].value;
  ExtratoComCarto.extratoPOST(authenticationType,clientId,token,body)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
...
module.exports.identificacaoPOST = function identificacaoPOST (req, res, next) {
  ...
  var token = req.swagger.params['token'].value;
  var body = req.swagger.params['body'].value;
  ExtratoComCarto.identificacaoPOST(authenticationType,clientId,token,body)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
