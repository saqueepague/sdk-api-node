...
var RecargaCelular = require('../service/RecargaCelularService');
...
module.exports.consultaPrePagoPOST = function consultaPrePagoPOST (req, res, next) {
  ...
  RecargaCelular.consultaPrePagoPOST(authenticationType,clientId,token,body)
...
module.exports.recargaPrePagoConfPOST = function recargaPrePagoConfPOST (req, res, next) {
  ...
  var token = req.swagger.params['token'].value;
  var body = req.swagger.params['body'].value;
  RecargaCelular.recargaPrePagoConfPOST(authenticationType,clientId,token,body)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
...
module.exports.recargaPrePagoPOST = function recargaPrePagoPOST (req, res, next) {
  ...
  var token = req.swagger.params['token'].value;
  var body = req.swagger.params['body'].value;
  RecargaCelular.recargaPrePagoPOST(authenticationType,clientId,token,body)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
