...
var EmprstimoComCarto = require('../service/EmprstimoComCartoService');
...
module.exports.consultaLimitesEmprestimoPOST = function consultaLimitesEmprestimoPOST (req, res, next) {
  ...
  EmprstimoComCarto.consultaLimitesEmprestimoPOST(authenticationType,clientId,token,body)
...
module.exports.consultaParcelasEmprestimoPOST = function consultaParcelasEmprestimoPOST (req, res, next) {
  ...
  var token = req.swagger.params['token'].value;
  var body = req.swagger.params['body'].value;
  EmprstimoComCarto.consultaParcelasEmprestimoPOST(authenticationType,clientId,token,body)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
...
module.exports.emprestimoConfPOST = function emprestimoConfPOST (req, res, next) {
  ...
  var token = req.swagger.params['token'].value;
  var body = req.swagger.params['body'].value;
  EmprstimoComCarto.emprestimoConfPOST(authenticationType,clientId,token,body)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
...
module.exports.emprestimoPOST = function emprestimoPOST (req, res, next) {
  ...
  var token = req.swagger.params['token'].value;
  var body = req.swagger.params['body'].value;
  EmprstimoComCarto.emprestimoPOST(authenticationType,clientId,token,body)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
...
module.exports.identificacaoPOST = function identificacaoPOST (req, res, next) {
  ...
  var token = req.swagger.params['token'].value;
  var body = req.swagger.params['body'].value;
  EmprstimoComCarto.identificacaoPOST(authenticationType,clientId,token,body)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
