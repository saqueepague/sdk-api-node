...
var EmprestimoSemCartao = require('../service/EmprestimoSemCartaoService');
...
module.exports.consultaParcelasEmprestimoPOST = function consultaParcelasEmprestimoPOST (req, res, next) {
  ...
  EmprestimoSemCartao.consultaParcelasEmprestimoPOST(authenticationType,clientId,token,body)
...
module.exports.emprestimoConfPOST = function emprestimoConfPOST (req, res, next) {
  ...
  var token = req.swagger.params['token'].value;
  var body = req.swagger.params['body'].value;
  EmprestimoSemCartao.emprestimoConfPOST(authenticationType,clientId,token,body)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
...
module.exports.emprestimoPOST = function emprestimoPOST (req, res, next) {
  ...
  var token = req.swagger.params['token'].value;
  var body = req.swagger.params['body'].value;
  EmprestimoSemCartao.emprestimoPOST(authenticationType,clientId,token,body)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
...
module.exports.tokenPOST = function tokenPOST (req, res, next) {
  ...
  EmprestimoSemCartao.tokenPOST(authenticationType,clientId,clientSecret)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
